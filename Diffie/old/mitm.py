...
class Attacker(threading.Thread):
    def run(self):
        ...
        while 1:
            ...
            print("\nCalculated K1 of Bob:", K_from_bob)
            print("Calculated K2 of Alice:", K_from_alice)
...
if __name__ == "__main__":
    ...
    xd_alice = int(input("\nEnter the modified private key of Alice (XD1): "))
    print("Modified private key of Alice (XD1): ", xd_alice)

    xd_bob = int(input("Enter the modified private key of Bob (XD2): "))
    print("Modified private key of Bob (XD2): ", xd_bob)
