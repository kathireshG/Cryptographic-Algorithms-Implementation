...
if __name__ == "__main__":
    ...
    ciphertext = receive_cipher_text()
    print("Received Ciphertext from Sender:", ciphertext.hex())
    recovered_plaintext = aes_decryption(ciphertext, key)
    print("\n\nDecrypted text in Hex:", recovered_plaintext.hex())
    print("\n\nDecrypted Plaintext:", recovered_plaintext.decode())